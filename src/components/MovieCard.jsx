  ...
  return (
    <>
      ...
      <div className="h-auto lg:mr-5 mr-3 text-center flex flex-col 2xl:min-w-[18%] lg:min-w-[22%] md:min-w-[24%] sm:min-w-[28%] min-w-[32%]">
        <div
          className="movieCard w-full rounded-lg mb-1 overflow-hidden bg-transparent relative 
          hover:border-2 hover:border-red-700"
        >
          <Link 
            to={`explore/${movie.movieId}`}
          >
            <div
              id="temp"
        ...
        <div className="mt-1 text-slate-100 xl:text-xl font-semibold lg:text-lg md:text-base sm:text-sm text-xs cursor-pointer hover:text-red-600">
          {movie.movieTittle}
        </div>
      </div>
    </>
